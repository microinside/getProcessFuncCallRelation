...
PIN="/home/e/pin"
OBJ="Obj/getProcessFuncCallRelation"
...
$(OBJ).o:getProcessFuncCallRelation.cpp
	g++ -c -Wall -Werror -Wno-unknown-pragmas  -O3 -fomit-frame-pointer -DBIGARRAY_MULTIPLIER=1 -DUSING_XED  -fno-strict-aliasing -I$(PIN)/source/tools/Include -I$(PIN)/source/tools/InstLib -I$(PIN)/extras/xed2-ia32/include -I$(PIN)/extras/components/include -I$(PIN)/source/include -I$(PIN)/source/include/gen -fno-stack-protector -DTARGET_IA32 -DHOST_IA32 -DTARGET_LINUX -O3 -fomit-frame-pointer -o $(OBJ).o getProcessFuncCallRelation.cpp
